        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    <img src="/upload/DSC_0009.jpg"" alt="Paddock" width="500" height="500">
                    <div class="carousel-caption">
                        <h3>Paddock</h3>
                        <p>De paddock geeft de ruimte aan de paarden om hun benen even lekker te strekken.</p>
                    </div>
                </div>

                <div class="item">
                    <img src="/upload/DSC_0022.jpg" alt="Stapmolen" width="500" height="500">
                    <div class="carousel-caption">
                        <h3>Paddock</h3>
                        <p>Vooral in de winter kunnen ze even lekker luchten.</p>
                    </div>
                </div>
